...
namespace Northwind.Web.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(NorthwindContext context, IServiceManager serviceManager = null)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var order = await _serviceManager.OrderService.GetOrdersAllService(false);
            return View(order);
        }
