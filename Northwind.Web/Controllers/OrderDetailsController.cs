...
namespace Northwind.Web.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(NorthwindContext context, IServiceManager serviceManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var orderDetailDtos = await _serviceManager.OrderDetailService.GetOrdersAllService(false);
